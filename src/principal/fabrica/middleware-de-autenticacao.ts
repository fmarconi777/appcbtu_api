import { MiddlewareDeAutenticacao } from '../../apresentacao/middlewares/middleware-de-autenticacao'
import { Middleware } from '../../apresentacao/protocolos/middleware'
import { ConsultaFuncionarioPeloTokenBd } from '../../dados/casos-de-uso/middleware/consulta-funcionario-pelo-token-bd'
